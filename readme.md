...
- for the 5x5 matrix: the optimized version runs in a 1/3 of the time and allocates 37% less memory. 
- for the 64x64 matrix: the optimized version runs in a 1/10 of the time and allocates 93% less memory.